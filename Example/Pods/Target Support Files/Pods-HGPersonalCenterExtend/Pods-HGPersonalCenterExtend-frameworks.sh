...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/HGCategoryView/HGCategoryView.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/HGPersonalCenterExtend/HGPersonalCenterExtend.framework"
